...
int func_usage::execute()
{
    std::cout
        ...
        << "  " << "  " << "          " << "usage:" << "  " << "nava func up {func_name} --image {image_name} [--stateful] [--policy {policy_name}] [--namespace {namespace}]"  << std::endl
        << "  " << "  " << "          " << "      " << "  " << "  " << "[--replicas {replicas}] [--update [--update-type {update_type}]]" << std::endl
        ...
        << "  " << "  " << "          " << "  " << "replicas" << "    " << "replicas number" << std::endl
        << std::endl
