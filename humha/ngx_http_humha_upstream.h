...
ngx_int_t ngx_http_humha_upstream(ngx_http_request_t * r, ngx_http_humha_loc_conf_t * lcf, ngx_http_humha_upstream_resolve_fptr_t fptr, ngx_int_t is_unixsock);
